/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe175833a69bffd38e48767daa7d83bf)
// Runtime types generated with workerd@1.20260317.1 2026-03-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CampaignStore";
	}
	interface Env {
		CAMPAIGN_ASSETS: R2Bucket;
		CAMPAIGN_STORE: DurableObjectNamespace<import("./src/server").CampaignStore>;
	}
}
